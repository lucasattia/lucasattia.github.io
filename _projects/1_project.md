...
---
In this project, we sought to generate core-shell hydrogel particles. 

<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/particle.png" title="Particle" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
